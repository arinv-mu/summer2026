 ...
 * Sample 1: Struct Pointers and Arrow Operator
 *
 * Demonstrates:
 * - Pointers to structures
 * - Arrow operator (->) for struct member access through pointers
 * - Linked list node creation and manipulation
 * - Dynamic structure allocation with malloc
 */
