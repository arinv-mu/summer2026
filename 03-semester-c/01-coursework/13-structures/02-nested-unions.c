/*
 * Topic: Structures
 * Sample 2: Nested Structures and Unions
 *
 * Demonstrates:
 * - Nested structures (struct within struct)
 * - Union types for memory-efficient storage
 * - Memory representation and sizing
 * - Combining multiple data types efficiently
 */
