/*
 * Topic: File I/O
 * Sample 2: Binary File Operations and Structure Persistence
 *
 * Demonstrates:
 * - Binary file reading with fread() and writing with fwrite()
 * - Serializing structures to binary files
 * - Deserializing structures from binary files
 * - Random access in binary files with fseek()
 */
