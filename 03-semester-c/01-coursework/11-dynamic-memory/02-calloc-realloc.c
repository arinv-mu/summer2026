 ...
 * Sample 2: calloc() and realloc() for Advanced Allocation
 *
 * Demonstrates:
 * - calloc() for zero-initialized memory allocation
 * - realloc() for resizing previously allocated memory
 * - Comparison between malloc and calloc semantics
 * - Proper reallocation error handling
 */
