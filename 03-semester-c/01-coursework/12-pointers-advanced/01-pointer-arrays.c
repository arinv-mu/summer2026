 ...
 * Sample 1: Arrays of Pointers and Memory Management
 *
 * Demonstrates:
 * - Declaring and using arrays of pointers
 * - Storing multiple independently allocated values
 * - Memory safety practices with pointer arrays
 * - Dynamic allocation within pointer arrays
 */
